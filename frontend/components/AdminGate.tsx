...
/**
 * Password gate for admin areas (catalog, logistics). Verifies against the
 * backend and keeps the password in sessionStorage so any admin tab stays
 * unlocked for the session. The password never ships in the client bundle.
 */
