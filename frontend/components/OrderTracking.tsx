    ...
    <div className="mx-auto max-w-7xl p-4 pb-24 lg:p-6 lg:pb-6">
      ...
      {viewing && (
        <div className="card mb-5 border-exicom-teal/40 bg-slate-50">
          ...
          {/* KPI summary — lead time across the order's key milestones */}
              ...
              {(() => {
                ...
                const metrics = [
                  ...
                  },
                  {
                    ...
                    sub: "FG Ready − SO Creation",
                    from: viewing.date_of_order,
                    to: stageDate("fg_ready"),
                  },
                  {
                    key: "dispatch",
                    label: "Days to dispatch",
                    sub: "Dispatched − FG Ready",
                    from: stageDate("fg_ready"),
                    to: stageDate("dispatched"),
                  },
                ];
